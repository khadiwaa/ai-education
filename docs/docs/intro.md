...
This is a living document. If something is out of date, confusing, or missing — fix it. See [CONTRIBUTING.md](https://github.com/your-org/ai-education-hl/blob/main/CONTRIBUTING.md).
