...
Use the `/model` command in your Copilot CLI session to see available models and switch between them. Models like `claude-sonnet-4.5` and `claude-opus-4.8` have reasoning effort parameters that you can set:
